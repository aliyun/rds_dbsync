...
RUN set -ex \
    ...
    && yum remove -y mysql-community-devel postgresql10-devel unzip gcc gcc-c++ make cpp glibc-devel glibc-headers libicu-devel libstdc++-devel \
    ...
    && ls -alhR /dbsync && mysql --version && psql --version && ldd /dbsync/bin/*
